...
const AddCard = ({ editMode = false }: { editMode?: boolean }) => {
    ...
    return (
        <>
            {showTutorial && ReactDOM.createPortal(<Tutorial writingDir={writingDir} />, portalElement)}
            ...
            <div className={classes.addCardWrapper} dir={t('globalDir')} style={needsRevision ? { backgroundColor: "#FAF1ED" } : {}}>
                ...
                <div dir={writingDir} style={{ display: "flex", justifyContent: "space-evenly", alignItems: "center", width: "100vw" }}>
                ...
                <input dir={writingDir} id="related" value={textStates.related} onChange={handleChangeText} type="text" className={classes.otherInput} placeholder={t('related_words')} style={needsRevision ? { backgroundColor: "#FAF1ED" } : {}} />
